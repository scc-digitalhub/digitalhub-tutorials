...
- Project
   ...
   4. Run the pipeline
    ...
    ```
    Check the status of workflow pipeline
    ```
    ...
    'COMPLETED'
    ```
    Once completed, one can now explore the results of the function. We can fetch the list of dataitems using digithub sdk.
    ```
